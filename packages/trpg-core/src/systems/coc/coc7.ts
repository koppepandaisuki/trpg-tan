...
export const coc7: SystemDefinition = {
  ...
  skills: [
    ...
    // 対人
    { key: "psychology", label: "心理学", base: 10, category: "知識" },
    ...
    // 戦闘
    { key: "fighting_brawl", label: "近接戦闘(白兵)", base: 25, category: "戦闘", specializable: true },
    { key: "firearms_handgun", label: "射撃(拳銃)", base: 20, category: "戦闘", specializable: true },
    {
      key: "firearms_rifle",
    ...
    { key: "drive_auto", label: "運転(自動車)", base: 20, category: "行動", specializable: true },
    ...
    { key: "pilot", label: "操縦", base: 1, category: "技術", specializable: true },
    { key: "computer", label: "コンピューター", base: 5, category: "技術" },
    { key: "electronics", label: "電子工学", base: 1, category: "技術" },
    { key: "art_craft", label: "芸術/製作", base: 5, category: "技術", specializable: true },
    // 知識
    ...
    { key: "science", label: "科学", base: 1, category: "知識", specializable: true },
    { key: "psychoanalysis", label: "精神分析", base: 1, category: "知識" },
    { key: "survival", label: "サバイバル", base: 10, category: "知識", specializable: true },
    {
      key: "own_language",
      label: "母国語",
      base: 0,
    ...
    { key: "other_language", label: "他の言語", base: 1, category: "対人", specializable: true },
