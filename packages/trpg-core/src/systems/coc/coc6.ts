...
export const coc6: SystemDefinition = {
  ...
  skills: [
    ...
    { key: "art", label: "芸術", base: 5, category: "知識", specializable: true },
    { key: "craft", label: "製作", base: 5, category: "知識", specializable: true },
    {
      key: "own_language",
      label: "母国語",
      base: 0,
    ...
    { key: "other_language", label: "他の言語", base: 1, category: "知識", specializable: true },
