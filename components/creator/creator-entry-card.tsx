...
export function CreatorEntryCard() {
  return (
    ...
    >
      <Card className="overflow-hidden border-border bg-gradient-to-br from-rose-500/8 via-transparent to-red-500/8 shadow-sm transition-all group-hover:border-foreground/20 group-hover:shadow-md">
