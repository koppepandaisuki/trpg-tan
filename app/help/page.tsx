  ...
  return (
    <>
      ...
      <PageContainer className="space-y-6 py-8">
        ...
        {/* お問い合わせ CTA */}
        <Card className="overflow-hidden border-indigo-200 bg-indigo-50/40 shadow-sm">
          <CardContent className="flex flex-col items-start gap-3 py-6 sm:flex-row sm:items-center sm:justify-between">
            ...
            <a
              ...
              className="inline-flex shrink-0 items-center gap-2 rounded-md border border-indigo-300 bg-indigo-100 px-4 py-2 text-sm font-medium text-indigo-800 transition hover:bg-indigo-200"
            >
